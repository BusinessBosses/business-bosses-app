              ...
              Container(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Obx(() {
                      final List<String> forumLikes = profileController
                          .getLikes(widget.forum.forumId, widget.forum.likes);
                      final List<String> forumCoins = profileController
                          .getCoins(widget.forum.forumId, widget.forum.coins);
