...
//                           onImagePicker: _settingModalBottomSheet,
//                           height: 96.0,
//                           width: 96.0,
//                         ),
//                       ),
...
//                                     ),
//                                     TextFormField(
//                                       enabled: _firebase.email == null
//                                           ? true
//                                           : false,
//                                       initialValue: _firebase.email ?? "",
//                                       onChanged: (val) {
//                                         bool? result =
//                                             Validator.isUniqueUsername(
//                                                 val, _usersToCompareUsername);
...
//                                         title: 'Title',
//                                         list: AnalyserData.getIndustryField(
//                                             _industry),
//                                       ),
//                                       child: Container(
//                                         width: double.infinity,
...
//                                         _bio = val;
//                                         debugPrint(
//                                             '_EditProfileScreenState.build: $_bio, $val');
//                                       },
//                                       maxLength: 150,
//                                       maxLines: 5,
...
//   Future<void> _onImagePick(ImageSource imageSource) async {
//     try {
...
//       }
//     } catch (exception) {
//       debugPrint('_EditProfileScreenState._onImagePick catch: e: $exception');
...
//       MaterialPageRoute(
//         builder: (context) => DataSelectionScreen(
//           analyser: analyser,
//         ),
//       ),
//     );
...
//         debugPrint(
//             '_EditProfileScreenState.onDataPicker: res.data: ${res.data}');
