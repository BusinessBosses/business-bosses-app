...
import '../presentation/publicprofilescreen.dart';
...
class _BossOfWeekProfileTileState extends State<BossOfWeekProfileTile> {
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      child: Container(
          ...
          padding:
              const EdgeInsets.only(top: 0.0, bottom: 15.0, left: 15, right: 0),
  ...
  void connectToUser() async {
    final checkConnected = widget.myProfile.connecteds == null
        ? -1
        : widget.myProfile.connecteds!
            .indexWhere((element) => element == user.uid);
    if (checkConnected == -1) {
