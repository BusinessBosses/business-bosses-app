...
class ExpandedCourseScreen extends StatefulWidget {
  ...
  const ExpandedCourseScreen({Key? key}) : super(key: key);
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        Flexible(
                          child: Text(
                            'Course Title jjh sjhjks hsjh jshsjkhsjk hs kshjs jkhsj kjsh kjs hjksh jksh sjkhsk ',
                    ...
                    Text(
                      'Course Description hs dshjks ddksjh jksdh jsdhk hgsj hjgs hhgshjg jhgd s dshgjhkjhjksh s',
