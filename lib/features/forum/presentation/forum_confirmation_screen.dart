                ...
                child: Column(
                  ...
                  children: <Widget>[
                        ...
                        Expanded(
                          child: Container(
                            ...
                            child: const TextWidget(
                              text:
                                  'Congratulations on choosing to boost your listing! It\'s always great to have your goods and services shared with a wider audience. 🎉',
                              size: 12,
                        ...
                        Expanded(
                          child: Column(
                            children: <Widget>[
                              ...
                              TextWidget(
                                text:
                                    'Your listing has been sent for review. Most ads are reviewed in 24 hours, although in some cases it will take longer.',
                                size: 13,
                    ...
                    MyButton(
                      ...
                      label: 'Ok',
                      onPressed: () {
                        Get.offAndToNamed(Routes.allforumscreen);
                      },
                    ),
                  ],
                ),
