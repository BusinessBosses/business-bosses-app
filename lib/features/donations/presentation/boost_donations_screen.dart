...
/// BOOST DONATION SCREEN
class BoostDonation extends StatefulWidget {
...
class _BoostDonationState extends State<BoostDonation> {
  ...
  Future<void> _loadBoostProducts() async {
    try {
      ...
      debugPrint('Error loading donation boost products: $e');
    }
  }
  ...
  Future<void> updatePost(String method) async {
    await ApiService.put(
      path: 'donation/approve/${widget.donationId}',
      body: <String, dynamic>{
        'isActive': true,
        'isApproved': true,
      },
