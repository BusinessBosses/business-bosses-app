                      ...
                      Expanded(
                        child: Container(
                          ...
                          child: const TextWidget(
                            text:
                                'Congratulations on choosing to boost your donation! 🎉',
                            size: 12,
                      ...
                      Expanded(
                        child: Column(
                          children: <Widget>[
                            ...
                            TextWidget(
                              text:
                                  'Your donation has been sent for review. Most ads are reviewed in 24 hours, although in some cases it will take longer.',
                              size: 13,
