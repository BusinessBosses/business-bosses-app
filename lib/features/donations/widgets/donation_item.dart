          ...
          children: <Widget>[
            Padding(
              padding: EdgeInsets.only(
                  top: widget.isHome == true ? 10 : 15.0,
                  left: widget.isHome == true ? 10 : 15.0,
                  right: widget.isHome == true ? 10 : 15.0,
                  bottom: 10),
              child: Row(
                                ...
                                children: <Widget>[
                                  ...
                                  Row(
                                    ...
                                    children: <Widget>[
                                      ...
                                      GestureDetector(
                                        onTap: () {
                                          widget.donation.setViews(
                                              widget.donation.views! + 1);
                                          ApiService.put(
                                              path:
                                    ...
                                    Row(
                                      ...
                                      children: <Widget>[
                                        ...
                                        Wrap(
                                          ...
                                          children: <Widget>[
                                            Text(
                                              formatter.format(widget.donation
                                                  .transactions!.length),
                                              style: const TextStyle(
                                                  fontSize: 10,
                                                  color: subtextColor,
                    ...
                    child: GestureDetector(
                      ...
                      child: Container(
                        decoration: BoxDecoration(
                            ...
                            border:
                                Border.all(width: 1.5, color: primaryColorLT)),
                        child: const Center(
                          child: Padding(
