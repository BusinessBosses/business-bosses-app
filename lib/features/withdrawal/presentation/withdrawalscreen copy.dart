                    ...
                    child: Column(
                      ...
                      child: CustomButton(
                        ...
                        onPressed: () async {
                          ...
                          if (_withdrawlamountcontroller.text.isEmpty) {
                          ...
                          } else if (num.parse(_withdrawlamountcontroller.text) < 5000) {
                            showSnackbar(
                              title: 'OOPS!',
                              message: 'Withdrawal amount cannot be less than 5000 coins, please try again!',
                              error: true,
                            );
                          } else if (num.parse(_withdrawlamountcontroller.text) >
                              _profileController.myProfile.coinsCount) {
                            showSnackbar(
                              title: 'OOPS!',
                              message: 'Withdrawal amount cannot exceed your balance, please try again!',
                              error: true,
                            );
                            ...
                            await coinHistoryController.makeWithdrawal(<String, dynamic>{
                              'status': 'Pending',
                              'approved': false,
                              'duration': null,
