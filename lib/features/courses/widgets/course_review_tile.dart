...
/// import 'rep';
class CourseReviewTile extends StatefulWidget {
  final dynamic post;
...
class _CourseReviewTileState extends State<CourseReviewTile> {
  bool hide = false;
                    ...
                    onTap: () {
                      if (profileController.myProfile.uid ==
                        ...
                        Get.toNamed(Routes.publicProfile,
                            arguments: UserModel.fromMap(widget.post['rater']));
                      }
                    },
                    child: UserAvatarWithBadge(
                      user: UserModel.fromMap(widget.post['rater']),
                      height: 55.0,
                      width: 55.0,
                      radius: 50.0,
