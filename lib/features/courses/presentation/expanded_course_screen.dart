...
class _ExpandedCourseScreenState extends State<ExpandedCourseScreen> {
  ...
  void initState() {
    ...
    if (widget.course.courseType == 'paid' &&
      ...
      courseController.checkUserAccess(widget.course);
    } else {
      courseController.courseAccess.value = true;
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(
      () => Scaffold(
        ...
        body: courseController.courseLoading.value
                        ...
                        background: Padding(
                          ...
                          child: Stack(
                            children: <Widget>[
                              ...
                              Visibility(
                                visible: !courseController.courseAccess.value,
                            ...
                            child: Column(
                              ...
                              children: <Widget>[
                                                                        ...
                                                                        actions: <Widget>[
                                                                          ...
                                                                          GestureDetector(
                                                                            onTap:
                                                                              ...
                                                                              setState(() {
                                                                                blocked.add(widget.course.user!.uid);
                                                                              });
                                                                  ...
                                                                  title:
                                                                    ...
                                                                    child: widget.course.user?.isSubscribed ==
                                                                        ...
                                                                        ? Row(
                                                                            children: <Widget>[
                                                                              TextWidget(
                                                                                text: 'Block @${widget.course.user?.name}',
                                                                                color: Colors.blue,
                                                                              ),
                                                                        ...
                                                                        actions: <Widget>[
                                                                          ...
                                                                          GestureDetector(
                                                                            onTap:
                                                                                () {
                                                                              Navigator.pop(context);
                                                                              showSnackBar(context, message: 'Course has been Reported');
                                                                            },
                                                                            child:
                                                                                Container(
                                                                              padding: const EdgeInsets.symmetric(
                                    ...
                                    Stack(children: <Widget>[
                                      Row(
                                        children: <Widget>[
                                          ...
                                          widget.course.user?.isSubscribed ==
                                                  true
                                                          ...
                                                          children: <Widget>[
                                                            ...
                                                            Positioned(
                                                                ...
                                                                child: selectedVideo ==
                                                                    ...
                                                                    ? Container()
                                                                    : (index < combinedList.length &&
                                                                            isValidYoutubeUrl(combinedList[index]))
                                                                        ? Icon(
                                ...
                                combinedList.length > 1
                                    ...
                                    : Container(),
                                courseController.courseAccess.value
                                    ? Container()
                                    : Center(
