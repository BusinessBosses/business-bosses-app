                        ...
                        Expanded(
                          child: Container(
                            ...
                            child: const TextWidget(
                              text:
                                  'Congratulations on choosing to boost your course! It\'s always a great feeling to have your thoughts and ideas shared with a wider audience. 🎉',
                              size: 12,
                        ...
                        Expanded(
                          child: Column(
                            children: <Widget>[
                              ...
                              TextWidget(
                                text:
                                    'Your course has been sent for review. Most ads are reviewed in 24 hours, although in some cases it will take longer.',
                                size: 13,
