...
class BoostMarket extends StatefulWidget {
  ...
  final String postId;
  @override
  State<BoostMarket> createState() => _BoostMarketState();
}

class _BoostMarketState extends State<BoostMarket> {
  ...
  Future<void> updatePost() async {
    ApiService.put(path: 'markets/${widget.postId}', body: <String, dynamic>{
      'promote': true,
